...
with open("data/direct_loss_train.csv", "w", newline="") as f:
    writer = csv.writer(f)
...
with open("data/direct_loss_test.csv", "w", newline="") as f:
    writer = csv.writer(f)
    writer.writerow(["step", "seed", "batch size", "lr", "loss"])
    for (step, seed, batch_size, lr), loss in loss_test.items():
        writer.writerow([step, seed, batch_size, lr, loss])
with open("data/direct_one_test.csv", "w", newline="") as f:
    writer = csv.writer(f)
...
with open("data/direct_output_test.csv", "w", newline="") as f:
    writer = csv.writer(f)
...
with open("data/direct_psnr_test.csv", "w", newline="") as f:
    writer = csv.writer(f)
