...
df1 = pd.read_csv("data/direct_loss_train_final.csv")
df2 = pd.read_csv("data/direct_loss_test_final.csv")
df3 = pd.read_csv("data/direct_one_test_final.csv")
df4 = pd.read_csv("data/direct_output_test_final.csv")
df5 = pd.read_csv("data/direct_psnr_test_final.csv")

idf1 = pd.read_csv("data/indirect_loss_train_final.csv")
idf2 = pd.read_csv("data/indirect_loss_test_final.csv")
idf3 = pd.read_csv("data/indirect_one_test_final.csv")
idf4 = pd.read_csv("data/indirect_output_test_final.csv")
...
indirect_one_acc = idf3[(idf3["lr"] == lr) & (idf3["batch size"] == bs)]
...
def get_test_out(lr, batch_size, idx, df):
    ...
    test_out.append(eval(df[(df["lr"] == lr) & (df["batch size"] == batch_size) & (df["idx"] == idx) & (df["step"] == 200)].iloc[0].output))
    test_out.append(eval(df[(df["lr"] == lr) & (df["batch size"] == batch_size) & (df["idx"] == idx) & (df["step"] == 240)].iloc[0].output))
    return test_out
